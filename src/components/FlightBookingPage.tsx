...
//         originLocationCode: searchForm.from,
//         destinationLocationCode: searchForm.to,
...
//       const response = await apiRequest('GET', `http://localhost:5000/api/flights/search?${params}`);
...
//     try {
//       const response = await apiRequest('GET', `http://localhost:5000/api/flights/airports?keyword=${query}`);
//       const data = await response.json();
//       return data.data || [];
//     } catch (error) {
...
//       const response = await apiRequest('POST', 'http://localhost:5000/api/flights/book', {
//         flightOffer,
//         travelers: [
//           {
//             id: '1',
