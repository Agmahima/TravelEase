...
//     console.log("offerId truthy:", !!offerId);
//     console.log("=====================================");
...
//       document.body.style.overflow = 'unset';
//     };
//   }, [isOpen, offerId, checkInDate, checkOutDate, adults, children]);
...
//       if (!offerId || offerId === undefined || offerId === null || offerId === '' || offerId === 'undefined') {
//         console.error("❌ Offer ID validation failed:", { 
//           offerId, 
//           type: typeof offerId, 
//           stringified: String(offerId) 
//         });
//         throw new Error(`Offer ID is required. Received: "${offerId}" (${typeof offerId})`);
//       }
...
//       // Convert offerId to string to ensure it's properly formatted
//       const offerIdString = String(offerId);
//       console.log("🆔 Using offer ID:", offerIdString);

//       const params = new URLSearchParams({
//         offer_id: offerIdString, // Add offer_id as query parameter
